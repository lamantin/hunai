# -*- coding: utf-8-*-
"""
A Speaker handles audio output from Hunai to the user
...
class EspeakTTS(AbstractTTSEngine):
    """
    Uses the eSpeak speech synthesizer included in the Hunai disk image
    ...
    def get_config(cls):
        ...
        profile_path = hunaipath.config('profile.yml')
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Hunai TTS module')
